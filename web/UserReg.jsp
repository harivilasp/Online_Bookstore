...
<!-- InstanceEndEditable -->
<link rel="stylesheet" type="text/css" href="admin/styles/bootstrap-4.0.0-beta.2-dist/css/bootstrap.css">
<script type="text/javascript" src="admin/styles/bootstrap-4.0.0-beta.2-dist/js/bootstrap.js"></script>
...
<button class="btn btn-outline-light item" style="margin-left:100px;">AboutUs</button>
<button class="btn btn-outline-light item" style="margin-left:100px;">Contact</button>
<button class="btn btn-outline-light item" style="margin-left:100px;">About College</button>
...
<div class="container-fluid">
    <div class="row">
        ...
        <img src="Saved Pictures/room1.jpg" width="100%" height="70%"></img>
         </div>
        <div class="col-8 content1" style="border:solid 1px #333333;">
            
            <!-- InstanceBeginEditable name="m1" -->

        <h1>User Regiteration</h1>
        <form name="form1" method="post" action="UserReg1.jsp">
          <p>Name
